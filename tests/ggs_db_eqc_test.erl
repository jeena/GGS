...
start() ->
    io:format("prop_set_Item: "),
    eqc:quickcheck(ggs_db_eqc_test:prop_setItem()),
    io:format("prop_remove_Item: "),
    eqc:quickcheck(ggs_db_eqc_test:prop_removeItem()),
    io:format("prop_clear: "),
    eqc:quickcheck(ggs_db_eqc_test:prop_clear()),
    io:format("prop_length: "),
    eqc:quickcheck(ggs_db_eqc_test:prop_length()),
    io:format("prop_key: "),
    eqc:quickcheck(ggs_db_eqc_test:prop_key()).
